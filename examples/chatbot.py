...
st.set_page_config(
    page_title="GroupA4week10deliverable Demo Application",
    page_icon=":robot:",
    layout="wide"
)
...
# Header
st.markdown("<div class='header'><h1>GroupA4week10deliverable Demo Application</h1></div>", unsafe_allow_html=True)
